import { CreditCard, IndianRupee, Package, PencilLine, Star, Trash, TrendingUp, Users } from "lucide-react";
...
const page = () => {
    ...
    return (
        <div className="flex flex-col gap-y-4">
            <h1 className="title">Admin Panel Dashboard</h1>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div className="card">
                    <div className="card-header">
                        <div className="w-fit rounded-lg bg-blue-500 bg-blue-500/20 p-2 transition-colors dark:bg-blue-600/20 dark:text-blue-600">
                            <Package size={24} />
                        </div>
